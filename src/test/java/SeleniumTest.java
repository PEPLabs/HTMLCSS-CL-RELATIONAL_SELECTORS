...
public class SeleniumTest {
    ...
    public void testRelationalSelectors() {
        try {
            ...
            Assert.assertEquals("rgba(173, 216, 230, 1)", childElement1BgColor);
            ...
            Assert.assertEquals("rgba(173, 216, 230, 1)", childElement2BgColor);
            ...
            Assert.assertEquals("20px", h2Element1FontSize);
            ...
            Assert.assertEquals("rgba(0, 128, 0, 1)", h2Element2Color);
            ...
            Assert.assertEquals("1px solid rgb(0, 0, 0)", siblingElementBorder);

            String siblingElementBgColor = siblingElement.getCssValue("background-color");
            Assert.assertEquals("rgba(255, 255, 0, 1)", siblingElementBgColor);
            ...
            Assert.assertEquals("rgba(211, 211, 211, 1)", generalSibling1BgColor);
            ...
            Assert.assertEquals("10px", generalSibling2MarginTop);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
